...
class IchimokuUpTrendDT(Generator):
    ...
    def __init__(self, settings=None, engine_settings=None):
        ...
        self.ichimoku: pd.DataFrame = None
        self.upper_trend: pd.Series = None
        self.lower_trend: pd.Series = None
